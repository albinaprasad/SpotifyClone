...
class MusicAdapter(val context: Context,var musicList: ArrayList<Music>,var plalist:Boolean=false) : RecyclerView.Adapter<MusicAdapter.musicViewHolder>(){
    ...
    override fun onBindViewHolder(
        ...
        holder.musicBinding.duration.text = musicList[position].formatDuration(musicList[position].duration)
    ...
    class musicViewHolder(val musicBinding: SongDetailsBinding): RecyclerView.ViewHolder(musicBinding.root)
    {
